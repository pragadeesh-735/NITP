        ...
        <div class="row g-6">
            <div class="offset-lg-2 col-lg-8">
                <div class="contact-right n0-bg n30-border radius16 p-xxl-8 px-lg-6 p-5">
                    ...
                    <?= $this->Form->create($cardApplicationDetail, ['class' => 'writere-v1', 'id' => 'cardapplication', 'enctype' => 'multipart/form-data']) ?>
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-cmn mb-xxl-4 mb-3">
                                <label for="room_type" class="fs-six fw_500 n700-color mb-xxl-3 mb-2">Upload Payment Receipt <span class="mandatory">*<b>(pdf,jpg,jpeg format only allowed)<b></span> </label>

                                <?= $this->Form->control('upload_reciept', [
                                    'type' => 'file',
