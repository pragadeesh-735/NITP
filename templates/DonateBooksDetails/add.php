        ...
        <div class="row g-6">
            <div class="offset-lg-2 col-lg-8">
                <div class="contact-right n0-bg n30-border radius16 p-xxl-8 px-lg-6 p-5">
                    ...
                    <?= $this->Form->create($donateBooksDetail, ['class' => 'writere-v1', 'id' => 'donateBooks', 'enctype' => 'multipart/form-data']) ?>
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-cmn mb-xxl-4 mb-3">
                                <label class="fs-six fw_500 n700-color mb-xxl-3 mb-2">Upload Excel of books to be donated <span class="mandatory">*<b>(xls,xlsx format only allowed)</b></span></label>

                                <?= $this->Form->control('upload_book', ['type' => 'file', 'id' => 'uploadReceipt', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'class' => 'n20-bg']) ?>
                            </div>
...
<script>
    ...
    document.getElementById('uploadReceipt').addEventListener('change', function() {
        ...
        if (!allowedExtensions.exec(filePath)) {
            errorSpan.textContent = 'Invalid file type. Only .xls, .xlsx format are allowed.';
            fileInput.value = '';
            return false;
        } else {
